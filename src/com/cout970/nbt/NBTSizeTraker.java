...
public class NBTSizeTraker {

	private final long maxNumOfBits;
	private long allocatedBits;
	
	public NBTSizeTraker(long maxTam){
		maxNumOfBits = maxTam;
	}
	...
	public void allocate(long numBytes){
		...
		if(allocatedBits > maxNumOfBits){
			System.out.println("Error al leer un NBT demasido grande, se ha intentado alocar: "+allocatedBits+" cuando el maximo es: "+maxNumOfBits);
		}
	}
	
	public static void readUTF(NBTSizeTraker tracker, String data){
